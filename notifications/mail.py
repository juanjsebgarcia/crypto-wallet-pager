...
try:
    email_SMTPSERVER = json.loads(open('settings.json', 'r').read())[
        'Email_SMTPSERVER']
    email_USERNAME = json.loads(open('settings.json', 'r').read())[
        'Email_USERNAME']
    email_PASSWORD = json.loads(open('settings.json', 'r').read())[
        'Email_PASSWORD']
    email_FROMEMAIL = json.loads(open('settings.json', 'r').read())[
        'Email_FROMEMAIL']
    email_activate = True
except:
